...
void srv_ui_serial_out_loop()
{
  ...
  srv_ui_serial_sns_air_hum_report();
...
void srv_ui_serial_sns_air_hum_report()
{
#ifdef USE_SRV_SNS_AIR_HUM
  float hum = srv_sns_air_GetHumidity();
